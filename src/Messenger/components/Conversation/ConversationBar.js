...
import USER_DETAIL_QUERY from "./Content/UserDetail.graphql";
...
const ConversationBar = ({ username, dispatchToggleMessageDetail, client }) => (
  <ConversationBarWrapper>
    ...
    <ConversationMenu>
      ...
      <a
        onClick={dispatchToggleMessageDetail}
        onMouseOver={() =>
          client.query({
